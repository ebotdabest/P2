...
class PythonParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by PythonParser#import_sig.
    def visitImport_sig(self, ctx:PythonParser.Import_sigContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by PythonParser#import_params_header.
    def visitImport_params_header(self, ctx:PythonParser.Import_params_headerContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by PythonParser#import_va_args.
    def visitImport_va_args(self, ctx:PythonParser.Import_va_argsContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by PythonParser#import_return_type.
    def visitImport_return_type(self, ctx:PythonParser.Import_return_typeContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by PythonParser#import_params.
    def visitImport_params(self, ctx:PythonParser.Import_paramsContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by PythonParser#import_param.
    ...
    # Visit a parse tree produced by PythonParser#for_expr.
    def visitFor_expr(self, ctx:PythonParser.For_exprContext):
        return self.visitChildren(ctx)
